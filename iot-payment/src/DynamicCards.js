...
import { Device, Action, ActionFactory,Voting } from "./web3/contracts";
...
export function DynamicCardsAction({ items }) {
  ...
  const createProposal= async()=>{
    ...
    await voting.createProposal("test",currrentAction.organisationAddress,currrentAction.ActionAddress,2000)
  }
