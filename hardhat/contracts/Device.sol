...
contract Device is Ownable {
    ...
    constructor(
        ...
        address _deviceFactoryAddress,
        address _organisationAddress
    ) Ownable(_deviceOwner) {
        id = _id;
        name = _name;
    ...
    function updateName(string memory _newName) external {
        require(
            ...
            "Only the DeviceFactory is allowed to call this Contract"
        );
        name = _newName;
    }
}
